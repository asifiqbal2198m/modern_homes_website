  ...
  return (
    <section className="bg-luxury-cream py-24 min-h-screen flex items-center justify-center">
      <div className="mx-auto w-full max-w-md rounded-3xl bg-white p-8 sm:p-10 border border-luxury-gold/10 shadow-xl">
        <h1 className="text-3xl font-bold font-serif text-luxury-charcoal">Admin Login</h1>
        <p className="mt-2 text-sm text-slate-500 font-light">Sign in to manage catalog, hero media, blog posts, and customer messages.</p>
